...
class Card(LegacySourceMixin, StripeModel):
    ...
    address_country = models.TextField(
        max_length=5000, blank=True, null=True, help_text="Billing address country."
    )
    ...
    address_zip = models.TextField(
        max_length=5000, blank=True, null=True, help_text="ZIP or postal code."
    )
    ...
    name = models.TextField(
        max_length=5000, null=True, blank=True, help_text="Cardholder name."
    )
